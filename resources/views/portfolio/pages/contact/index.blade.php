                ...
                <form id="contactForm" method="POST" action="{{ route('contact') }}">
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control" id="phone" type="tel" placeholder="(123) 456-7890"
                            data-sb-validations="required" name="nomorHp" />
                        <label for="phone">Phone number</label>
                        <div class="invalid-feedback" data-sb-feedback="phone:required">A phone number is required.</div>
                    </div>
                    <div class="form-floating mb-3">
                        <input class="form-control" id="phone" type="text" placeholder="my adress is ..."
                            data-sb-validations="required" name="alamat" />
                        <label for="phone">Adress</label>
                        <div class="invalid-feedback" data-sb-feedback="alamat:required">adress is required.</div>
                    </div>
                    <!-- Message input-->
                    <div class="form-floating mb-3">
                        <textarea class="form-control" id="message" type="text" placeholder="Enter your message here..."
                            style="height: 10rem" data-sb-validations="required" name="isi"></textarea>
